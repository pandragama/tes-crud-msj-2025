<div class="flex flex-wrap gap-4">
    ...
    <div class="flex-1 flex flex-row gap-4 text-nowrap p-6 bg-white rounded-lg shadow-sm dark:bg-gray-800">
        <div>
        ...
        <div class="w-full flex justify-between">
            ...
            <h5 class="text-right pl-6 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">{{ $item->count }}</h5>
        </div>
    </div>
    @endforeach
    ...
    <div class="flex-1 flex flex-row gap-4 text-nowrap p-6 bg-white rounded-lg shadow-sm dark:bg-gray-800">
        ...
        <div class="w-full flex justify-between">
            ...
            <h5 class="text-right pl-6 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">{{ $employeeStatusSummary['total'] }}</h5>
        </div>
    </div>
