                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-white">Add Data Form</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('employees.store') }}" class="py-6 px-6 flex flex-col">
                    @csrf
                    <div class="grid grid-cols-6 gap-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="flex flex-wrap gap-2 mt-1" x-data="{ selectedRam: '{{ old('gender') }}' }">
                                @php
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="flex flex-wrap gap-2 mt-1" x-data="{ selectedStatus: '{{ old('status') }}' }">
                                @php
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="flex flex-wrap gap-2 mt-1" x-data="{ selectedDept: '{{ old('dept_id') }}' }">
                                @php
